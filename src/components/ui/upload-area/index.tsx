...
import { Dialog, DialogContent, DialogTitle, DialogTrigger } from "../dialog/radix-dialog";
...
export default function UploadArea({
  ...
  return (
    <div
      {...getRootProps()}
      className={`border-dashed flex flex-col justify-center items-center border-2 rounded-lg cursor-pointer min-w-[200px] px-4 w-full min-h-[100px] h-full relative ${
